...
const char descriptor_table_protodef_test_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "onse\022\035\n\004code\030\001 \001(\0132\017.fixbug.ResCode\022\017\n\007s"
  "uccess\030\002 \001(\010\"[\n\004User\022\014\n\004name\030\001 \001(\014\022\013\n\003ag"
  "e\030\002 \001(\r\022\035\n\003sex\030\003 \001(\0162\020.fixbug.User.Sex\"\031"
  "\n\003Sex\022\007\n\003MAN\020\000\022\t\n\005WOMAN\020\001\"&\n\024GetFriendLi"
  "stRequest\022\016\n\006userid\030\001 \001(\r\"Y\n\025GetFriendLi"
  "stResponse\022\035\n\004code\030\001 \001(\0132\017.fixbug.ResCod"
  "e\022!\n\013friend_list\030\002 \003(\0132\014.fixbug.User2\225\001\n"
  "\016UserServicePpc\0224\n\005Login\022\024.fixbug.LoginR"
  "equest\032\025.fixbug.LoginResponse\022M\n\016GetFrie"
  "ndLists\022\034.fixbug.GetFriendListRequest\032\035."
  "fixbug.GetFriendListResponseB\003\200\001\001b\006proto"
  "3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_test_2eproto = {
  false, false, descriptor_table_protodef_test_2eproto, "test.proto", 561,
...
void LoginResponse::InitAsDefaultInstance() {
  ::fixbug::_LoginResponse_default_instance_._instance.get_mutable()->code_ = const_cast< ::fixbug::ResCode*>(
      ::fixbug::ResCode::internal_default_instance());
}
class LoginResponse::_Internal {
 public:
  static const ::fixbug::ResCode& code(const LoginResponse* msg);
};
...
LoginResponse::LoginResponse(const LoginResponse& from)
  ...
  if (from._internal_has_code()) {
    code_ = new ::fixbug::ResCode(*from.code_);
  } else {
    code_ = nullptr;
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.LoginResponse)
  ...
  if (from.has_code()) {
    _internal_mutable_code()->::fixbug::ResCode::MergeFrom(from._internal_code());
  }
  if (from.success() != 0) {
...
void GetFriendListResponse::InitAsDefaultInstance() {
  ::fixbug::_GetFriendListResponse_default_instance_._instance.get_mutable()->code_ = const_cast< ::fixbug::ResCode*>(
      ::fixbug::ResCode::internal_default_instance());
}
class GetFriendListResponse::_Internal {
 public:
  static const ::fixbug::ResCode& code(const GetFriendListResponse* msg);
};
...
UserServicePpc::~UserServicePpc() {}

const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* UserServicePpc::descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_test_2eproto);
  return file_level_service_descriptors_test_2eproto[0];
}

const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* UserServicePpc::GetDescriptor() {
  return descriptor();
}

void UserServicePpc::Login(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
...
void UserServicePpc::GetFriendLists(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
...
void UserServicePpc::CallMethod(const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method,
...
const ::PROTOBUF_NAMESPACE_ID::Message& UserServicePpc::GetRequestPrototype(
...
const ::PROTOBUF_NAMESPACE_ID::Message& UserServicePpc::GetResponsePrototype(
    const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method) const {
  GOOGLE_DCHECK_EQ(method->service(), descriptor());
  switch(method->index()) {
    case 0:
...
UserServicePpc_Stub::UserServicePpc_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel)
  : channel_(channel), owns_channel_(false) {}
UserServicePpc_Stub::UserServicePpc_Stub(
...
void UserServicePpc_Stub::Login(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
...
void UserServicePpc_Stub::GetFriendLists(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
